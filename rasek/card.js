...
const questions = [
    {
        ...
        choices: [
            ...
            },
            {
                ...
                value: () => {
                    open('https://rasekdk.github.io/rasekdk/')
                }
            },
            {
                name: 'Just quit',
...
const data = {
    ...
    twitter: chalk.gray('https://twitter.com/') + chalk.hex('#1da1f2').bold('rasekdk'),
    github: chalk.gray('https://github.com/') + chalk.hex('#0550ae').bold('rasekdk'),
    linkedin: chalk.gray('https://linkedin.com/in/') + chalk.hex('#0A66C2').bold('rasekdk'),
